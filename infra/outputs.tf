output "db_instance_address" {
  description = "O endereço da instância RDS"
...
output "db_instance_endpoint" {
  description = "O ponto de conexão"
  value       = module.db.db_instance_endpoint
}

output "db_instance_engine" {
  description = "O mecanismo do banco de dados"
  value       = module.db.db_instance_engine
}

output "db_instance_engine_version_actual" {
  description = "A versão em execução do banco de dados"
  value       = module.db.db_instance_engine_version_actual
}

output "db_instance_hosted_zone_id" {
  description = "O ID da zona hospedada canônica da instância RDS (para ser usado em um registro de Alias do Route 53)"
...
output "db_instance_resource_id" {
  description = "O ID do recurso RDS desta instância"
  value       = module.db.db_instance_resource_id
}

output "db_instance_status" {
  description = "O status da instância RDS"
...
output "db_instance_username" {
  description = "O nome de usuário master do banco de dados"
...
output "db_subnet_group_id" {
  description = "O nome do grupo de sub-rede do DB"
  value       = module.db.db_subnet_group_id
}

output "db_subnet_group_arn" {
  description = "O ARN do grupo de sub-rede do DB"
  value       = module.db.db_subnet_group_arn
}

output "db_parameter_group_id" {
  description = "O ID do grupo de parâmetros do DB"
  value       = module.db.db_parameter_group_id
}

output "db_parameter_group_arn" {
  description = "O ARN do grupo de parâmetros do DB"
  value       = module.db.db_parameter_group_arn
}

output "db_enhanced_monitoring_iam_role_arn" {
  description = "O Nome de Recurso da Amazon (ARN) especificando a função de monitoramento"
  value       = module.db.enhanced_monitoring_iam_role_arn
}

output "db_instance_cloudwatch_log_groups" {
  description = "Mapa dos grupos de logs do CloudWatch criados e seus atributos"
  value       = module.db.db_instance_cloudwatch_log_groups
}

output "db_instance_master_user_secret_arn" {
  description = "O ARN do segredo do usuário master (Disponível apenas quando manage_master_user_password está definido como true)"
